  ...
  return (
    <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-[#ffffff] px-4 max-w-4xl mx-auto">
        <Badge
          variant="secondary"
          className="mb-4 bg-[#ffffff]/20 text-[#fffff] border-[#ffffff]/30">
        ...
        <p className="text-xl mb-8 text-[#ffffff]/90 max-w-2xl mx-auto animate-slide-up">
          {" "}
          Explore our curated collection of premium products designed for the
          modern lifestyle. Quality, style, and innovation in every purchase.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-scale-in">
          ...
          <Link href="/categories">
            <Button
              size="lg"
              variant="outline"
              className="bg-[#ffffff]/10 border-[#ffffff]/30 text-[#ffffff] hover:bg-[#ffffff]20">
              Explore Categories
